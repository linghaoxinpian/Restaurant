    ...
    <table class="MainArea_Content" cellspacing="0" cellpadding="0">
        ...
        <tbody id="TableData">
			...
			<tr class="TableDetail1">
				...
				<td>
					<a href="/wirelessplatform/board.jsp?method=update&id=1&isBook=0" class="FunctionButton">退桌</a>				
			...
			<tr class="TableDetail1">
				...
				<td align="center"></td>
				<td>
					<a href="/wirelessplatform/board.jsp?method=update&id=2&isBook=1" class="FunctionButton">预定</a>				
			...
			<tr class="TableDetail1">
				...
				<td align="center"></td>
				<td>
					<a href="/wirelessplatform/board.jsp?method=update&id=3&isBook=1" class="FunctionButton">预定</a>				
			...
			<tr class="TableDetail1">
				...
				<td align="center"></td>
				<td>
					<a href="/wirelessplatform/board.jsp?method=update&id=5&isBook=1" class="FunctionButton">预定</a>				
